...
public class ModKeyBindings {
    ...
    public static void initialize(BalmKeyMappings keyMappings) {
        keyPortableCrafting = keyMappings.registerKeyMapping("key.craftingcraft.portable_crafting", KeyConflictContext.UNIVERSAL, KeyModifier.NONE, GLFW.GLFW_KEY_C, "key.categories.craftingcraft");
        keyBackToInventory = keyMappings.registerKeyMapping("key.craftingcraft.back_to_inventory", KeyConflictContext.GUI, KeyModifier.NONE, InputConstants.UNKNOWN.getValue(), "key.categories.craftingcraft");
