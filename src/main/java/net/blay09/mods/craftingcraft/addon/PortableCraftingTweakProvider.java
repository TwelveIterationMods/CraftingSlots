...
public class PortableCraftingTweakProvider implements TweakProvider {
    ...
    public ItemStack transferIntoGrid(EntityPlayer entityPlayer, Container container, int i, ItemStack itemStack) {
        return defaultProvider.transferIntoGrid(entityPlayer, container, ((ContainerPortableCrafting) container).getCraftMatrix(), itemStack);
    }

    @Override
    public ItemStack putIntoGrid(EntityPlayer entityPlayer, Container container, int i, ItemStack itemStack, int slotNumber) {
        return defaultProvider.putIntoGrid(entityPlayer, container, ((ContainerPortableCrafting) container).getCraftMatrix(), itemStack, slotNumber);
    }

    @Override
    public IInventory getCraftMatrix(EntityPlayer entityPlayer, Container container, int i) {
        return ((ContainerPortableCrafting) container).getCraftMatrix();
    }
