...
public class InventoryCraftingTweakProvider implements TweakProvider<InventoryCraftingContainer> {
    ...
    @Override
    public int getCraftingGridSize(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id) {
        return 9;
    }

    @Override
    public void clearGrid(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id, boolean forced) {
    ...
    @Override
    public void rotateGrid(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id, boolean counterClockwise) {
        defaultProvider.rotateGrid(this, id, entityPlayer, container, counterClockwise);
    }

    @Override
    public void balanceGrid(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id) {
        defaultProvider.balanceGrid(this, id, entityPlayer, container);
    }

    @Override
    public void spreadGrid(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id) {
        defaultProvider.spreadGrid(this, id, entityPlayer, container);
    }

    @Override
    public boolean canTransferFrom(PlayerEntity entityPlayer, InventoryCraftingContainer container, int i, Slot slot) {
        return defaultProvider.canTransferFrom(entityPlayer, container, slot);
    }

    @Override
    public boolean transferIntoGrid(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id, Slot slot) {
        return defaultProvider.transferIntoGrid(this, id, entityPlayer, container, slot);
    }

    @Override
    public ItemStack putIntoGrid(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id, ItemStack itemStack, int index) {
        return defaultProvider.putIntoGrid(this, id, entityPlayer, container, itemStack, index);
    }

    @Override
    public IInventory getCraftMatrix(PlayerEntity entityPlayer, InventoryCraftingContainer container, int id) {
