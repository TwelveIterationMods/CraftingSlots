...
public class TileEntityCraftingTableFrame extends TileEntityStoneCraftingTable {
    ...
    public void onDataPacket(NetworkManager net, S35PacketUpdateTileEntity pkt) {
        ...
        worldObj.markAndNotifyBlock(xCoord, yCoord, zCoord, worldObj.getChunkFromBlockCoords(xCoord, zCoord), CraftCraft.craftingTableFrame, CraftCraft.craftingTableFrame, 1 | 2);
    }
