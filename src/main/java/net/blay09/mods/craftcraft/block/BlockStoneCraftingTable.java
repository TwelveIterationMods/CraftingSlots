...
public class BlockStoneCraftingTable extends BlockContainer {
    ...
    public BlockStoneCraftingTable() {
        super(Material.rock);
        setBlockName("craftcraft:stoneCraftingTable");
        setHardness(2f);
        setResistance(10f);
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        sideIcon[0] = iconRegister.registerIcon("craftcraft:stoneCraftingTable_side");
        topIcon[0] = iconRegister.registerIcon("craftcraft:stoneCraftingTable_top");
        frontIcon[0] = iconRegister.registerIcon("craftcraft:stoneCraftingTable_front");

        sideIcon[1] = iconRegister.registerIcon("craftcraft:netherCraftingTable_side");
        topIcon[1] = iconRegister.registerIcon("craftcraft:netherCraftingTable_top");
        frontIcon[1] = iconRegister.registerIcon("craftcraft:netherCraftingTable_front");
    }
