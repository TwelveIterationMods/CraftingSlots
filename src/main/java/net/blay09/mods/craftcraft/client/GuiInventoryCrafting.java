...
public class GuiInventoryCrafting extends GuiContainer {
    ...
    private final ResourceLocation texture = new ResourceLocation("craftcraft", "textures/gui/portableCraftingTable.png");
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRendererObj.drawString(I18n.format("craftcraft:container.inventoryCraftingTable"), 8, ySize - 96 + 1, 4210752);
    }
